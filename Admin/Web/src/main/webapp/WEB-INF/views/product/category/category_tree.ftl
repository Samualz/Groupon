...
<body>
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'" style="padding:5px;">
			<div id="tb" style="padding:1px;height:auto">
				<div style="margin-bottom:1px">
					<a href="#" class="easyui-linkbutton" iconCls="icon-add" onclick="addProductCategory();" plain="true">新建</a>
					<a href="#" class="easyui-linkbutton" iconCls="icon-edit" onclick="updateProductCategory();" plain="true">修改</a>
				</div>
			</div>
			<table id="dealCategoryGrid" class="easyui-datagrid" title="子类别列表" pagination="true" rownumbers="true" idField="id"
		...
		<#--商品类别编辑对话框-->
		<div id="deal_category_edit_dialog" class="easyui-dialog" style="width:500px;height:220px;" data-options="closed:true"></div>

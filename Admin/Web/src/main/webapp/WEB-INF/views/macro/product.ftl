...
<#macro generateProductClassRadio name defaultValue>
	<input id="dealClassVirtual" name="${name}" type="radio" value="1" <#if defaultValue == 1> checked </#if> /><label for="dealClassVirtual">虚拟</label>
	<input id="dealClassCommon" name="${name}" type="radio" value="0" <#if defaultValue == 0 || defaultValue == ''> checked </#if> /><label for="dealClassCommon">普通</label>
</#macro>

...
<#--计算最大页码-->
    ...
    <#--第一页-->
        <#if (pagingList.total > 0)>
            <a href="javascript:void(0)" onclick="submitSearch(1)" <#if pagingList.page == 1>class="current_page"</#if>>1</a>
        </#if>
    ...
    <#--如果不只有一页-->
        ...
        <#--当前页的前3页和后3页-->
            ...
            <#--如果位于第一页和最后一页之间-->
                <#if (index > 1) && (index < maxPageIndex)>
                    <a href="javascript:void(0)" onclick="submitSearch(${index})" <#if pagingList.page == index>class="current_page"</#if>>${index}</a>
                </#if>
            </#list>
        ...
        <#--最后页-->
            <a href="javascript:void(0)" onclick="submitSearch(${maxPageIndex})" <#if pagingList.page == maxPageIndex>class="current_page"</#if>>${maxPageIndex}</a>
        </#if>
